...
namespace Conversor
{
    ...
    {
        ApplicationDataContainer _stgs = ApplicationData.Current.LocalSettings;
        ...
        public App()
        {
            this.InitializeComponent(); // ApplicationLanguages.PrimaryLanguageOverride = "";
            #region Reconhecimento do idioma
            if (_stgs.Values.ContainsKey("Language")) ApplicationLanguages.PrimaryLanguageOverride = (string)_stgs.Values[("Language")];
            #endregion
